...
export async function GET() {
  try {
    ...
    // Query the JobResult collection to fetch jobId and jobDate fields and Sort job data by date in descending order (most recent first)
    const results = await JobResult.find({}, {}, { sort: { 'jobDate' : -1 } });
