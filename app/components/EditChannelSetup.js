 ...
 */
const EditChannelSetupComponent = ({ channelNames, onSubmit })=> {
  ...
  return (
    <Box component="form" onSubmit={handleSubmit} sx={{ maxWidth: 'xl', mx: 'auto', p: 8, bgcolor: 'white', boxShadow: 3, borderRadius: 2 }}>
      ...
      <DeleteConfirmationDialog
        ...
        title={`Delete ${selectedChannel} Channel`}
        message={`Are you sure you want to delete ${selectedChannel} channel?`}
      />
...
export default memo(EditChannelSetupComponent);